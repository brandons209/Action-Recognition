...
from keras.layers import Input, BatchNormalization, Activation, Conv3D, Dropout
from keras.layers import AveragePooling3D, MaxPooling3D, Dense, Flatten, GlobalAveragePooling2D
...
def DenseNet3D_Weight_Transfer(input_shape, growth_rate=32, block_config=(6, 12, 24, 16), num_init_features=64, bn_size=4, drop_rate=0, num_classes=5):
    ...
    pretrained_densenet = densenet.DenseNet201(include_top=False, input_shape=(224,224,3), input_tensor=inp_2d, weights='imagenet')
